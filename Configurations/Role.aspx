<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="Role.aspx.vb" Inherits="PriceCalc.Role" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH3" runat="server">
        ...
        <asp:Label ID="lblRole" runat="server" Font-Names="Arial"  style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 10%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Create Role" ForeColor="Black"></asp:Label>
        <asp:TextBox ID="TxtRole" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 5%; position: absolute; width: 16%; height: 9%;"></asp:TextBox>
    </asp:Panel>
</asp:Content>
