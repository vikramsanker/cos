<%@ Page Title="COS - Department Management" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="Department.aspx.vb" Inherits="PriceCalc.Department" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH3" runat="server">
    <asp:Panel ID="Panel3" runat="server" style="border-style: groove;border-color: inherit;border-width: medium;z-index: 1; left: 10px;top: 8%;position: absolute;height: 36%;width: 98%;overflow: scroll;">    
        <asp:Label ID="lblDept" runat="server" Font-Names="Arial"  style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 10%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Department" ForeColor="Black"></asp:Label>
        <asp:DropDownList runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 20%; position: absolute; width: 16%; height: 10%" ID="TxtDivision" AppendDataBoundItems="True">
            <asp:ListItem></asp:ListItem>
            <asp:ListItem>Technical</asp:ListItem>
            <asp:ListItem>Support</asp:ListItem>
        </asp:DropDownList>
        <asp:Label ID="lblDivision" runat="server" ForeColor="Black" Font-Names="Arial"  style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 25%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Division"></asp:Label>
        <asp:TextBox ID="TxtDept" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 5%; position: absolute; width: 16%; height: 9%;"></asp:TextBox>
    </asp:Panel>
</asp:Content>
