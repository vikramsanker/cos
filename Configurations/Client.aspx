<%@ Page Title="COS - Client Management" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="Client.aspx.vb" Inherits="PriceCalc.Client" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH3" runat="server">
        ...
        <asp:TextBox ID="TxtClient" runat="server" style="z-index: 1; Font-Size: 0.7vw;left: 7%; top: 5%; position: absolute; width: 16%; height: 9%"></asp:TextBox>
        ...
        <asp:Label ID="lblsales" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw;left: 47%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Salesperson"></asp:Label>
        <asp:DropDownList ID="Sales" runat="server" style="z-index: 1; Font-Size: 0.7vw;left: 53%; top: 35%; position: absolute; width: 16%; height: 10%;" AppendDataBoundItems="True">
            <asp:ListItem></asp:ListItem>
        </asp:DropDownList>
