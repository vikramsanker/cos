<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="Certification.aspx.vb" Inherits="PriceCalc.Certification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH3" runat="server">
    <asp:Panel ID="Panel3" runat="server" style="border-style: groove;border-color: inherit;border-width: medium;z-index: 1; left: 10px;top: 8%;position: absolute;height: 36%;width: 98%;overflow: scroll;">    
            ...
            <asp:Label ID="lblCertName" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 70%; top: 25%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Cert. Client"></asp:Label>
            <asp:TextBox ID="TxtCertClient" runat="server" style=" z-index: 1; Font-Size: 0.7vw; left: 76%; top: 20%; position: absolute; width: 16%; height: 9%" ReadOnly="True"></asp:TextBox>
            <asp:Label ID="lblCertAdd" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Cert. Address"></asp:Label>
            <asp:TextBox ID="TxtCertAddress" runat="server" style=" z-index: 1; Font-Size: 0.7vw; left: 7%; top: 35%; position: absolute; width: 39%; height: 9%" ReadOnly="True"></asp:TextBox>
            <asp:Label ID="lblNote" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 47%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Note"></asp:Label>
            <asp:TextBox ID="TxtNote" runat="server" style=" z-index: 1; Font-Size: 0.7vw; left: 53%; top: 35%; position: absolute; width: 16%; height: 18%" TextMode="MultiLine"></asp:TextBox>
   </asp:Panel>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
        ...
        <asp:Button ID="Update" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 30%; position: absolute; height: 40%; width: 7%;" Text="Mark Completed" />
