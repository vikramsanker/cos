<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="productionplan.aspx.vb" Inherits="PriceCalc.productionplan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    <asp:Panel ID="Panel4" runat="server" style="border-style: groove; border-color: inherit; border-width: medium; z-index: 1; left: 10px; top: 8%; position: absolute; height: 10%; width: 98%;">
        <asp:Label ID="LblEmployee" runat="server" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 50%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Select Officer" ForeColor="Black"></asp:Label>
        <asp:DropDownList ID="TxtCO" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 30%; position: absolute; width: 16%; height: 41%;" AppendDataBoundItems="True">
        <asp:ListItem></asp:ListItem>
        </asp:DropDownList>
        <asp:Button ID="Assign" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 24%; top: 30%; position: absolute; height: 40%; width: 7%;" Text="Assign" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH4" runat="server">
    <asp:Panel ID="Panel6" runat="server" style="border-style: groove;border-color: inherit;border-width: medium;z-index: 1;Font-Size: 0.7vw; left: 10px;top: 19%; position: absolute;height: 74%; width: 98%;background-color: #FFFFFF; overflow:scroll">
