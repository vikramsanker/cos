<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MainMasterPage.Master" CodeBehind="Collection.aspx.vb" Inherits="PriceCalc.Collection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH3" runat="server">
    <asp:Panel ID="Panel3" runat="server" style="border-style: groove;border-color: inherit;border-width: medium;z-index: 1; left: 10px;top: 8%;position: absolute;height: 36%;width: 98%;overflow: scroll;">    
            <asp:Label ID="LblClient" runat="server" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 10%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Client" ForeColor="Black"></asp:Label>
            <asp:DropDownList ID="TxtClient" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 5%; position: absolute; width: 16%; height: 10%; bottom: 196px;" AppendDataBoundItems="True" AutoPostBack="True">
            <asp:ListItem></asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="LblAddress" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 24%; top: 10%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Address Line 1"></asp:Label>
            ...
            <asp:TextBox ID="TxtTel" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 76%; top: 20%; position: absolute; width: 16%; height: 9%"></asp:TextBox>
            ...
            <asp:TextBox ID="TxtHP" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 35%; position: absolute; width: 16%; height: 9%"></asp:TextBox>
            <asp:Label ID="LblDOC" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 24%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Collection Date"></asp:Label>
            <asp:TextBox ID="TxtDOC" runat="server" Style="z-index: 1; Font-Size: 0.7vw; left: 30%; top: 35%; position: absolute; width: 16%; height: 9%" TextMode="Date">
            </asp:TextBox>
            <asp:Label ID="lblTransport" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 47%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Transporter"></asp:Label>
            <asp:DropDownList ID="TxtTrans" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 53%; top: 35%; position: absolute; width: 16%; height: 10%;" AppendDataBoundItems="True">
            <asp:ListItem></asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="lblNote" runat="server" ForeColor="Black" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 70%; top: 40%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Note to Transporter"></asp:Label>
            ...
            <asp:Label ID="LblSales" runat="server" Font-Names="Arial" style="z-index: 1; Font-Size: 0.7vw; left: 1%; top: 55%; position: absolute; height: 15%; width: 5%; vertical-align:inherit; text-align: right" Text="Caltek Sales" ForeColor="Black"></asp:Label>
            <asp:DropDownList ID="TxtSalesperson" runat="server" style="z-index: 1; Font-Size: 0.7vw; left: 7%; top: 50%; position: absolute; width: 16%; height: 9%;" AppendDataBoundItems="True">
            <asp:ListItem></asp:ListItem>
            </asp:DropDownList>
   </asp:Panel>
</asp:Content>
